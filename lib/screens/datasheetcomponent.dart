...
class DatasheetComponent extends StatefulWidget {
...
class _DatasheetComponentState extends State<DatasheetComponent> {
  ...
  Future<List<Component>> _getContracts() async{
    ...
    print("DDDDDDDDDD$value");
    final bearer = "Bearer "+value;
    var data = await http.get("http://localhost:5000/api/inspection_datasheet/$id", headers: {"Accept": "application/json", "authorization":bearer});
    var jsonData = json.decode(data.body);
